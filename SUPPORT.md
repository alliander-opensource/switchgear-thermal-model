...
There are a few ways to connect with the `switchgear_thermal_model` project:

* Submit an issue
* Send an email to the Technical Steering Committee: <switchgear-thermal-model@alliander.com>.
...
`switchgear_thermal_model`, but there's not yet reason to suspect you've
...
refer to [SECURITY.md](SECURITY.md) for how to disclose it.
